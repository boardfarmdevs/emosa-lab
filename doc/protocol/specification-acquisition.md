...
| ☐ | **Wi-Fi Data Elements 3.0 package, including TR-181-2-17_DEr3.xlsx** | [Member package cited by EasyMesh reference 10](https://www.wi-fi.org/file-member/wi-fi-data-elements-specification-package) | Exact package/access remains pending. On 2026-09-23 the operator supplied public BBF 2.17 references: 33 selected definitions match across pinned USP/CWMP XML, supporting a bounded `0xC5` codec and radio/AP/STA representation bridge. See the [BBF review](bbf-data-elements.md). Obtain the WFA package for direct equivalence/ambiguity review; independent encoding work can proceed using the stated BBF basis. Measurement-source qualification remains separate. |
| ☑ | **BBF TR-181 Issue 2 Amendment 17, Device:2.17 USP/CWMP full XML** | [USP](https://usp-data-models.broadband-forum.org/tr-181-2-17-0-usp.html), [CWMP](https://cwmp-data-models.broadband-forum.org/tr-181-2-17-0-cwmp.html) | Public publisher sources obtained and hashed on 2026-09-23. Explicit BBF basis for selected metric types, units and unavailable values; not a claim that `TR-181-2-17_DEr3.xlsx` has been acquired or is equivalent. Reproduction and remaining source issues are in the [review](bbf-data-elements.md). |
