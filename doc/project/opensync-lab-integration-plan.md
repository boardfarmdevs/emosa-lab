...
| EMOSA admission and mapping | [config.py](../../src/emosa/config.py), [mapping.py](../../src/emosa/opensync/mapping.py), [radio_scope.py](../../src/emosa/opensync/radio_scope.py), [session.py](../../src/emosa/opensync/session.py), [qualification.py](../../lab/src/emosa_lab/qualification.py) |
| EMOSA native integration | [fixture worker to refactor](../../lab/src/emosa_lab/simulation/native_onboarding.py), [onboarding lifecycle](../../src/emosa/wire/onboarding.py), [operation bridge](../../src/emosa/wire/operation_bridge.py), [native experiment guide](../protocol/native-onboarding.md) |
| EMOSA reporting | [station decoder](../../lab/src/emosa_lab/telemetry/stations.py), [BBF bridge](../../lab/src/emosa_lab/wire/bbf_metrics.py), [AP reports](../protocol/ap-metric-reports.md), [final-session statistics](../protocol/final-session-statistics.md), [sustained criteria](../protocol/sustained-operation.md) |
